...
```{r configuration, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
#Data variables
...
```{r dataprocessing, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
# Download data
...
```{r datasplitting, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
